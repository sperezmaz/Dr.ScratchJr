...
urlpatterns = [
    ...
    path('blocks/', views.blocks_view, name='blocks_view'),
    path('create_csv_zip/<str:zip_name>/', views.create_csv_zip,
         name='create_csv_zip'),
    ...
    path('analysis/<name>/<name_file>/', views.analysis_view,
         name='analysis_view'),
    path('analysis2/<name>/<project>/<file_name>', views.analysis2_view,
         name='analysis2_view'),
    path('results/<type1>/<type2>/', views.results_view, name='results_view'),
